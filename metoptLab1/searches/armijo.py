...
def armijo_line_search(
        x: float,
        y: float,
        noise_left_bound: float,
        noise_right_bound: float,
    ...
    alpha = alpha_init
    f_current = differentiable_function(x, y, noise_left_bound, noise_right_bound)
    ...
    for _ in range(max_iters):
        ...
        f_new = differentiable_function(x_new, y_new, noise_left_bound, noise_right_bound)
